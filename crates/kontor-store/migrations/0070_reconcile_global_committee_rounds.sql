-- Schema v70. Re-run the v69 table rebuilds under a new forward-only schema
-- generation. This repairs databases opened by an intermediate v69 build
-- whose Committee run/finding checks stopped at round three and whose
-- remediation-command claims still stopped at round two. It is also safe over
-- the published v69 shape: every row is copied byte-for-byte and the full
-- positive u8 round domain is reasserted consistently.

CREATE TABLE consultation_runs_v70 (
...
INSERT INTO consultation_runs_v70
...
ALTER TABLE consultation_runs_v70 RENAME TO consultation_runs;
...
CREATE TABLE committee_findings_v70 (
...
INSERT INTO committee_findings_v70
...
ALTER TABLE committee_findings_v70 RENAME TO committee_findings;
...
CREATE TABLE epic_completion_remediation_command_claims_v70 (
    project_id      TEXT    NOT NULL REFERENCES projects(id) ON DELETE RESTRICT,
...
INSERT INTO epic_completion_remediation_command_claims_v70
...
ALTER TABLE epic_completion_remediation_command_claims_v70
