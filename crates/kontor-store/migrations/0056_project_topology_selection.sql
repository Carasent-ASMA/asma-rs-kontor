-- Project topology selection is distinct authority from moving one existing
-- epic pin. Extend the closed command vocabulary without changing old rows.
CREATE TABLE command_receipts_v56 (
    ...
    kind             TEXT    NOT NULL CHECK (kind IN (
                                 ...
                                 'publish_topology_spec', 'select_project_topology',
                                 'upgrade_topology', 'retitle_container',
                                 'reconcile_native_names', 'apply_core_team',
                                 'ensure_quick_session', 'promote_quick_session',
                                 'materialize_core_team', 'correct_core_team_route',
...
INSERT INTO command_receipts_v56
...
ALTER TABLE command_receipts_v56 RENAME TO command_receipts;
