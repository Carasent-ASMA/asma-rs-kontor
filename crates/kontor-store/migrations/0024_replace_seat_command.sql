-- Schema v24. The Admin-only operator reconciliation that replaces one
-- runtime-terminal persistent seat with its linked successor.

CREATE TABLE command_receipts_v24 (
...
INSERT INTO command_receipts_v24
...
ALTER TABLE command_receipts_v24 RENAME TO command_receipts;
