-- Schema v85. A quota row can say an account is blocked and carry a digest of
...
--
-- Integrated after the naming-recovery generation so every deployed migration
-- remains append-only and uniquely numbered.
