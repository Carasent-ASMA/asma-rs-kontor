-- Add the explicit existing-session Core Team seat claim command kind.
CREATE TABLE command_receipts_v59 (
    ...
    kind TEXT NOT NULL CHECK (kind IN (
        ...
        'record_committee_findings', 'settle_committee_run', 'publish_trigger',
...
INSERT INTO command_receipts_v59
...
ALTER TABLE command_receipts_v59 RENAME TO command_receipts;
