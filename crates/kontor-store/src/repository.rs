...
use kontor_core::repository::{
    ...
    SourceEventIngest, SpecRepository, StoredCapacityConfiguration, StoredCoreTeamRevision,
...
use kontor_core::spec::{
    ...
    PersonaScenarioSpec, ProjectSessionTopologySpec, ProviderQuotaKind, ProviderQuotaSource,
