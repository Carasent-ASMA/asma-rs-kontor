...
- EVD-027 and EVD-028 inputs are present and hash-linked. EVD-029's desktop and phone screenshot hashes were rechecked against the committed artifacts and are recorded correctly in `EVD-INPUTS.md`. The KON-09 supersession and non-product KON-18 NOTES incident are visible in reconciliation.
