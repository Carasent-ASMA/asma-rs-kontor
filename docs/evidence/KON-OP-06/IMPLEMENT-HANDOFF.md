...
### Persistence — schema v35 (`0035_epic_completion.sql`)

The feature branch originally occupied schema v32; integration placed it after
OP-04 and the consultation catalog as v35 without changing its data contract.
